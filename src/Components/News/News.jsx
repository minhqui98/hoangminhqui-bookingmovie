                                ...
                                <div className="row">
                                    <div className="col-12 col-lg-6 p-2">
                                        ...
                                        <h5 className="newTitle">
                                            <a href="#news">
                                                Bán Đảo Peninsula là bom tấn xác sống không thể
                                                bỏ lỡ!
                              </a>
                                        </h5>
                                        <p>
                                            Là phần phim khép lại bộ ba xác sống (Seoul
                                            Station, Train to Busan - 2016) của đạo diễn Yeon
                                            Sang Ho, mới đây, bom tấn Bán Đảo (Train to Busan
                                    ...
                                    <div className="col-12 col-lg-6 p-2">
                                        <img
                                            src="https://tix-truong.web.app/img/news/image2.png"
                                            alt=""
                                            width="100%"
                                        />
                                        <h5 className="newTitle">
                                            <a href="#news">
                                                ‘Tôi sẽ làm tất cả ngỡ ngàng bởi phiên bản tà
                                                ác của mình’ - Song Ji Hyo
                              </a>
                                        </h5>
                                        <p className="subTitle">
                                            Nhân dịp tác phẩm “Kẻ Xâm Nhập” giữ vững ngôi
                                            vương phòng vé suốt gần một tuần trình chiếu tại
                                            quê nhà, ekip sản xuất liền cho đăng tải poster
